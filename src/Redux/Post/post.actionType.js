...
export const CREATE_COMMENT_REQUEST = "GET_USERS_POST_REQUEST";
export const CREATE_COMMENT_SUCCESS = "GET_USERS_POST_SUCCESS";
export const CREATE_COMMENT_FAILURE = "GET_USERS_POST_FAILURE";